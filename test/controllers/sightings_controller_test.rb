...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { asteroid_id: @sighting.asteroid_id, date_sighted: @sighting.date_sighted, dec: @sighting.dec, location: @sighting.location, magn: @sighting.magn, ra: @sighting.ra }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { asteroid_id: @sighting.asteroid_id, date_sighted: @sighting.date_sighted, dec: @sighting.dec, location: @sighting.location, magn: @sighting.magn, ra: @sighting.ra }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
